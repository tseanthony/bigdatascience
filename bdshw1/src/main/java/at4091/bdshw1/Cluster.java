...
//		// Hard Code first Centroid
	...
	private static double cosineSimilarity(double[] centroid, double[] input) {
		...
		double cosineAngle = dotProd / (inputLen * centroidLen);
	...
	private static double euclideanDistance(double[] centroid, double[] input) {
